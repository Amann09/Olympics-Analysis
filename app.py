...
st.sidebar.image('https://yt3.googleusercontent.com/ytc/AOPolaTrdydHCMrPGoG-JnWaXoesu10YLxRBcPaDYfF6GIM=s900-c-k-c0x00ffffff-no-rj')
...
if user_menu == 'Medal Tally':
    ...
    if selected_country == 'Overall' and selected_year != 'Overall':
        st.title(f'Overall Medal Tally of the Year {selected_year} Olympics')
    if selected_country != 'Overall' and selected_year == 'Overall':
        st.title(f'Overall Medals won by {selected_country}')
    if selected_country != 'Overall' and selected_year != 'Overall':
        st.title(f'Medals won by {selected_country} in the year {selected_year}')
...
if user_menu == 'Country-wise Analysis':
    ...
    # Medal Tally for a particular country
    country_df = helper.yearwise_medal_tally(df, selected_country)
    fig = px.line(country_df, x='Year', y='Medal')
    st.title(f'{selected_country} Medal Tally over the years')
    st.plotly_chart(fig)

    # Performance of a country in all sport
    st.title(f'{selected_country} excels in the following sport')
...
if user_menu == 'Athlete wise Analysis':
    ...
    # # Distribution of Age w.r.t. Sports (Gold Medalists)
    # x, name = [], []
